...
import com.example.foodbox.AdminFile.Model.A_UserNote;
...
public class OtpVarification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otpsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ProgressDialog progressDialog=new ProgressDialog(OtpVarification.this);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(Task<AuthResult> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        A_UserNote note=new A_UserNote(email,username,currentuser,phone,deviceToken);
                                        db.collection("Users").document(currentuser).set(note);
                                        progressDialog.dismiss();
                                        Intent i=new Intent(OtpVarification.this, A_Admin_Dashboard.class);
    ...
    private void sendMail() {
        ...
        //Send Mail
        try {
            A_JavaMailAPI javaMailAPI = new A_JavaMailAPI(this,email,subject,message);
